...
export const ChatItem = ({
  ...
  const canDeleteMessage = !deleted && (isAdmin || isModerator || isAdmin);
        ...
        <div className="flex flex-col w-full">
          ...
          {isImage && (
            <a
              ...
              className="relative aspect-square rounded-md mt-2 overflow-hidden border-hidden border flex items-center bg-secondary h-48 w-48"
            >
              <Image
                src={fileUrl}
                fill
                    ...
                    <FormItem className="flex-1">
                      <FormControl>
                        <div className="relative w-full">
                         ...
                         focus-visible:ring-0 focus-visible:ring-offset-0 text-zinc-600
                          dark:text-zinc-200"
